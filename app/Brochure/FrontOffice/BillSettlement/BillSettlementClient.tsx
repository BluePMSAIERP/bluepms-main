...
export default function BillSettlementClient() {
    return (
        <PremiumBackground>
            <div className="flex flex-col items-center min-h-screen p-8 max-w-7xl mx-auto space-y-12">
                ...
                >
                    Settle guest bills instantly with multiple payment modes, split-billing support, and print-ready invoices.
                </motion.p>
                ...
                >
                    <Image
                        src="/images/bill-settlement.png"
                        alt="Bill Settlement Interface"
                        width={1200}
                        height={800}
                    ...
                    {[
                        {
                            ...
                            desc: "Accept cash, cards, digital wallets, and bill-to-room simultaneously on one folio.",
                            icon: <Wallet className="w-6 h-6 text-black" />
                        },
                        {
                            title: "Express Check-Out",
                            desc: "Email invoices to guests for review and remote settlement to skip the front desk.",
                            icon: <Send className="w-6 h-6 text-black" />
                        },
                        {
                            title: "Direct Bill to Company",
                            desc: "Seamless transfer of charges to corporate accounts with credit limit checks.",
                            icon: <Building2 className="w-6 h-6 text-black" />
                        },
                        {
                            title: "Multi-Currency Support",
                            desc: "Real-time FX rates for settling bills in foreign currencies.",
                            icon: <Globe className="w-6 h-6 text-black" />
                        },
                        {
                            title: "Integrated Payment Gateway",
                            desc: "Secure, EMV-compliant processing directly within the PMS interface.",
                            icon: <ShieldCheck className="w-6 h-6 text-black" />
                        },
                        {
                            title: "Folio Archiving",
                            desc: "Digital storage and easy retrieval of past invoices for guest inquiries.",
